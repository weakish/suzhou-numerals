...
const rewrite_with_alternatives = (without_alternatives) => {
...
const encode = (n) => rewrite_with_alternatives([...n.toString()].map((d) => hangzhou[parseInt(d)])).join('');
